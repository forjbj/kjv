...
//     this.thirdBook = localStorage.getItem('thirdBookHTML');
  ...
  switch (book) {
    case 'current':
      ...
      this.bibleService.bookSelected = Number(localStorage.getItem('currentBookIndex'));
      localStorage.setItem('currentChapter', chapter);
      localStorage.setItem('currentScrollY', scroll);
      break;
    
    case 'second':
      this.bibleService.testament = Number(localStorage.getItem('secondTestamentIndex'));
      this.bibleService.bookSelected = Number(localStorage.getItem('secondBookIndex'));
      localStorage.setItem('currentChapter', localStorage.getItem('secondSavedChapter'));
      localStorage.setItem('currentScrollY', localStorage.getItem('secondScrollYSaved'));
  ...
  storeBooks() {
    ...
    //    localStorage.setItem('currentBookHTML', document.getElementById('currentBook').outerHTML);
      ...
      // The following 2 need to be here or history won't originally populate
      localStorage.setItem('currentTestamentIndex', (this.bibleService.testament).toString());
      localStorage.setItem('currentBookIndex', (this.bibleService.bookSelected).toString());
    }
  }
